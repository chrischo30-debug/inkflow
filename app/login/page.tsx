    ...
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-surface">
      ...
      <div className="flex-1 flex flex-col justify-center px-8 py-12 sm:px-12 md:px-16 lg:px-24 relative xl:max-w-2xl">
        ...
        <div className="w-full mt-20 md:mt-0">
          ...
          <p className="text-on-surface-variant mb-12">Enter your email and password to log in.</p>

          <form className="animate-in flex flex-col w-full gap-6 text-foreground" action={signIn}>
            ...
            <Button type="submit" className="w-full mt-4 h-auto py-3 text-sm font-medium rounded-xl bg-gradient-to-br from-primary to-primary-container text-on-primary shadow-sm hover:opacity-90 transition-opacity">
              Sign In
            </Button>
