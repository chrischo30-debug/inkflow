...
## System Overview
FlashBooker is a multi-tenant SaaS app. Each tattoo artist is a tenant with their own data,
...
- In-app calendar shows both FlashBooker bookings and pulled Google Calendar events
