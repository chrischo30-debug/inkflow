  ...
  return (
    <div className="space-y-5">
      ...
      {submitted ? (
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="rounded-2xl border border-gray-200 p-5 space-y-4 bg-white">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className="w-full px-3 py-2 text-sm text-gray-900 bg-white border border-gray-300 rounded-lg focus:outline-none focus:border-gray-900 resize-none placeholder:text-gray-400"
            />
